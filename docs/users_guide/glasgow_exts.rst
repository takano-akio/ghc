...
The :ghc-flag:`-XArgumentDo` extension allows these constructs to be directly
...
The :ghc-flag:`-XArgumentDo` extension moves these production rules under
``aexp``::
